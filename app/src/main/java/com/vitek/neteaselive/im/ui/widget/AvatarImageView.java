package com.vitek.neteaselive.im.ui.widget;
...
public class AvatarImageView extends CircleImageView {
    ...
    public static final int DEFAULT_THUMB_SIZE = (int) NimCache.getContext().getResources().getDimension(R.dimen.avatar_max_size);
