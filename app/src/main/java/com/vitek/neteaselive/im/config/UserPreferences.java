package com.vitek.neteaselive.im.config;
...
import com.vitek.neteaselive.Constant;
...
public class UserPreferences {
    ...
    static SharedPreferences getSharedPreferences() {
        return NimCache.getContext().getSharedPreferences(Constant.AUTH_NAME + "." + NimCache.getAccount(), Context.MODE_PRIVATE);
    }
}
